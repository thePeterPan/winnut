...
#define NUT_ST_ONLINE	0x001	/* UPS is on line (OL)			*/
#define NUT_ST_ONBATT	0x002	/* UPS is on battery (OB)		*/
#define NUT_ST_LOWBATT	0x004  	/* UPS has a low battery (LB)		*/
#define NUT_ST_FSD		0x008	/* master has set forced shutdown flag	*/
#define NUT_ST_MASTER	0x010	/* we are the master on this UPS	*/
/* was ST_ALIVE 0x020 */
#define NUT_ST_LOGIN	0x040  	/* we are logged into this UPS		*/
/* was ST_FIRST 0x080 */
#define NUT_ST_CONNECTED	0x100	/* upscli_connect returned OK		*/
...
typedef struct {
	...
	/* WinNUT feature */
	time_t  lastonlinepower;               /* time ups was last on power */
	void	*next;
}	utype;
...
#ifdef NOTIFY_LIST_MESSAGES_INCLUDE
